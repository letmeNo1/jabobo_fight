...
import { FighterSnapshot, WeaponType, SkillCategory } from '../types';
    ...
    switch (type) {
      ...
      case 'SKILL':
        return {
          ...
          name: '秘籍尊者·玄难',
          weapons: [],
          skills: SKILLS.filter(s => s.category === SkillCategory.ACTIVE || s.category === SkillCategory.SPECIAL).map(s => s.id)
        };
      case 'ALL_WEAPONS':
        return {
          ...baseStats,
