...
export const config = {
  ...
  "ATTACK_SEQUENCES": {
    "CLEAVE": {
      "steps": [
        { "state": "CLEAVE", "frame": 1, "offset": "BASE", "offsetY": -40, "moveDuration": 100, "delay": 100, "playSfx": true },
        { "state": "CLEAVE", "frame": 2, "offset": "MELEE", "offsetY": -180, "moveDuration": 250, "delay": 250 },
        { "state": "CLEAVE", "frame": 3, "offset": "MELEE", "offsetY": 0, "moveDuration": 80, "delay": 500, "calculateHit": true, "shaking": "SCREEN" }
      ]
    },
    "SLASH": {
      "steps": [
